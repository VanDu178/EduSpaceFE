...
import type { CreatePaymentAccountDto } from '../types';
...
interface FormCreateProps {
  ...
  onCancel: () => void;
  onSubmit: (values: CreatePaymentAccountDto) => void;
}
  ...
  return (
    ...
    >
      ...
      >
            ...
            options={banks.map((b) => ({
              ...
              label: (
                <div className="flex items-center gap-2 py-0.5">
                  ...
                  <span>-</span>
                  <span className="text-slate-500 text-xs truncate"> {b.name}</span>
                </div>
              ),
            }))}
          />
        ...
        <Form.Item
          label={<span className="text-xs font-semibold text-slate-700">Ghi chú</span>}
          name="note"
        >
