...
const FormCreate = ({
  ...
  const onFinish = async (values: any) => {
    ...
    if (bannerFile) {
      ...
      // const toastId = toast.loading('Đang tải ảnh bìa lên hệ thống...');
      try {
        ...
        toast.error("Đã xảy ra vấn đề khi tạo bài viết. Vui lòng thử lại!");
      ...
      >
        ...
        <div className="bg-white px-5 py-2.5 flex items-center justify-between z-10 shrink-0 border-b border-slate-200/80">
          <div className="flex items-center gap-2.5">
            ...
            />
            <h1 className="text-sm font-bold text-slate-800 tracking-tight">THÊM MỚI</h1>
          </div>
