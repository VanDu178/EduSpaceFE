  ...
  const columns: ColumnsType<Blog> = [
    ...
    },
    {
      ...
      render: (status, record) => (
        <Select
          value={status || BLOG_STATUS.DRAFT}
          ...
          options={[
            {
              ...
              label: (
                <span className={`text-xs font-bold ${getStatusTagConfig(BLOG_STATUS.DRAFT).textClass}`}>
                  {getStatusTagConfig(BLOG_STATUS.DRAFT).label}
                </span>
              ),
            },
            {
              ...
              label: (
                <span className={`text-xs font-bold ${getStatusTagConfig(BLOG_STATUS.PUBLISHED).textClass}`}>
                  {getStatusTagConfig(BLOG_STATUS.PUBLISHED).label}
                </span>
              ),
            },
            {
              ...
              label: (
                <span className={`text-xs font-bold ${getStatusTagConfig(BLOG_STATUS.ARCHIVED).textClass}`}>
                  {getStatusTagConfig(BLOG_STATUS.ARCHIVED).label}
                </span>
              ),
            },
          ]}
